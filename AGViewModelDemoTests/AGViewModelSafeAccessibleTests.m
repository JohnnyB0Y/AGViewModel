...
#pragma mark number
    ...
    NSNumber *number3 = [numberVM ag_safeSetNumber:empty forKey:kSafeKey3 handle:^(id  _Nullable value, BOOL safe) {
        XCTAssertTrue(value == nil, @"value必须为空!");
        XCTAssertTrue(safe == NO, @"数据判断不对!");
    }];
    NSNumber *number4 = [numberVM ag_safeSetNumber:null forKey:kSafeKey4 handle:^(id  _Nullable value, BOOL safe) {
    ...
    NSNumber *number7 = [numberVM ag_safeNumberForKey:kSafeKey3 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
        XCTAssertTrue(value == nil, @"value必须为空!");
        XCTAssertTrue(safe == NO, @"数据判断不对!");
        return returnNumber;
    }];
    NSNumber *number8 = [numberVM ag_safeNumberForKey:kSafeKey4 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
        XCTAssertTrue(value == nil, @"value必须为空!");
        XCTAssertTrue(safe == NO, @"数据判断不对!");
        return returnNumber;
    }];
...
#pragma mark string
    ...
    NSString *string3 = [stringVM ag_safeSetString:empty forKey:kSafeKey3 handle:^(id  _Nullable value, BOOL safe) {
		
        XCTAssertTrue(value == nil, @"value必须为空!");
        XCTAssertTrue(safe == NO, @"数据判断不对!");
    }];
    NSString *string4 = [stringVM ag_safeSetString:null forKey:kSafeKey4 handle:^(id  _Nullable value, BOOL safe) {
    ...
    NSString *string7 = [stringVM ag_safeStringForKey:kSafeKey3 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
		
        XCTAssertTrue(value == nil, @"value必须为空!");
        XCTAssertTrue(safe == NO, @"数据判断不对!");
        return returnString;
    }];
    NSString *string8 = [stringVM ag_safeStringForKey:kSafeKey4 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
...
#pragma mark array
    ...
    NSArray *array3 = [arrayVM ag_safeSetArray:empty forKey:kSafeKey3 handle:^(id  _Nullable value, BOOL safe) {
		
        XCTAssertTrue(value == nil, @"value必须为空!");
        XCTAssertTrue(safe == NO, @"数据判断不对!");
    }];
    NSArray *array4 = [arrayVM ag_safeSetArray:null forKey:kSafeKey4 handle:^(id  _Nullable value, BOOL safe) {
    ...
    NSArray *array7 = [arrayVM ag_safeArrayForKey:kSafeKey3 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
		
        XCTAssertTrue(value == nil, @"value必须为空!");
        XCTAssertTrue(safe == NO, @"数据判断不对!");
        return returnArray;
    }];
    NSArray *array8 = [arrayVM ag_safeArrayForKey:kSafeKey4 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
...
#pragma mark dictionary
    ...
    NSDictionary *dict3 = [dictVM ag_safeSetDictionary:empty forKey:kSafeKey3 handle:^(id  _Nullable value, BOOL safe) {
		
        XCTAssertTrue(value == nil, @"value必须为空!");
        XCTAssertTrue(safe == NO, @"数据判断不对!");
    }];
    NSDictionary *dict4 = [dictVM ag_safeSetDictionary:null forKey:kSafeKey4 handle:^(id  _Nullable value, BOOL safe) {
    ...
    NSDictionary *dict7 = [dictVM ag_safeDictionaryForKey:kSafeKey3 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
		
        XCTAssertTrue(value == nil, @"value必须为空!");
        XCTAssertTrue(safe == NO, @"数据判断不对!");
        return returnDict;
    }];
    NSDictionary *dict8 = [dictVM ag_safeDictionaryForKey:kSafeKey4 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
...
#pragma mark value type
    ...
    doubleValue = [valueTypeVM ag_safeDoubleValueForKey:kSafeKey1 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    doubleValue = [valueTypeVM ag_safeDoubleValueForKey:kSafeKey2 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    floatValue = [valueTypeVM ag_safeFloatValueForKey:kSafeKey1 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    floatValue = [valueTypeVM ag_safeFloatValueForKey:kSafeKey2 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    intValue = [valueTypeVM ag_safeIntValueForKey:kSafeKey1 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    intValue = [valueTypeVM ag_safeIntValueForKey:kSafeKey2 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    integerValue = [valueTypeVM ag_safeIntegerValueForKey:kSafeKey1 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    integerValue = [valueTypeVM ag_safeIntegerValueForKey:kSafeKey2 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    longlongValue = [valueTypeVM ag_safeLongLongValueForKey:kSafeKey1 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    longlongValue = [valueTypeVM ag_safeLongLongValueForKey:kSafeKey2 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    boolValue = [valueTypeVM ag_safeBoolValueForKey:kSafeKey1 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    boolValue = [valueTypeVM ag_safeBoolValueForKey:kSafeKey2 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
...
#pragma mark number string
    ...
    numberString = [valueTypeVM ag_safeNumberStringForKey:kSafeKey1 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
    ...
    numberString = [valueTypeVM ag_safeNumberStringForKey:kSafeKey2 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
...
- (void)testSafeNumber
{
    ...
    NSNumber *obj2 = [vm ag_safeSetNumber:saveObj2 forKey:kSafeKey2 handle:^(id  _Nullable value, BOOL safe) {
    ...
    obj2 = [vm ag_safeNumberForKey:kSafeKey2 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
...
- (void)testSafeString
{
    ...
    NSString *obj2 = [vm ag_safeSetString:saveObj2 forKey:kSafeKey2 handle:^(id  _Nullable value, BOOL safe) {
    ...
    obj2 = [vm ag_safeStringForKey:kSafeKey2 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
...
- (void)testSafeNumberString
{
    ...
    NSString *obj2 = [vm ag_safeNumberStringForKey:kSafeKey1 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
    ...
    obj2 = [vm ag_safeNumberStringForKey:kSafeKey2 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
...
- (void)testSafeArray
{
    ...
    NSArray *obj2 = [vm ag_safeSetArray:saveObj2 forKey:kSafeKey2 handle:^(id  _Nullable value, BOOL safe) {
    ...
    obj2 = [vm ag_safeArrayForKey:kSafeKey2 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
...
- (void)testSafeDictionary
{
    ...
    NSDictionary *obj2 = [vm ag_safeSetDictionary:saveObj2 forKey:kSafeKey2 handle:^(id  _Nullable value, BOOL safe) {
    ...
    obj2 = [vm ag_safeDictionaryForKey:kSafeKey2 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
...
- (void)testSafeValueType
{
    ...
    XCTAssertTrue(intValue == returnIntValue, @"返回数据不对!");
    intValue = [valueTypeVM ag_safeIntValueForKey:kSafeKey3 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    XCTAssertTrue(integerValue == returnIntegerValue, @"返回数据不对!");
    integerValue = [valueTypeVM ag_safeIntegerValueForKey:kSafeKey4 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    XCTAssertTrue(longlongValue == returnLongLongValue, @"返回数据不对!");
    longlongValue = [valueTypeVM ag_safeLongLongValueForKey:kSafeKey5 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
    ...
    XCTAssertTrue(boolValue == returnBoolValue, @"返回数据不对!");
    boolValue = [valueTypeVM ag_safeBoolValueForKey:kSafeKey6 handle:^NSNumber * _Nullable(id  _Nullable value, BOOL safe) {
...
- (void)testSafeURL
{
    ...
    obj1 = [vm ag_safeURLForKey:kSafeKey1 handle:^id _Nullable(id  _Nullable value, BOOL safe) {
